...
export function FloatingMobileCTA() {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-50 border-t border-border-light bg-white/95 px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] backdrop-blur-sm transition-all duration-300 sm:hidden ${
        visible
