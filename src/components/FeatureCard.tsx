...
export function FeatureCard({ feature }: FeatureCardProps) {
  return (
    <div className="group flex flex-col rounded-xl border border-border-light bg-white p-6 transition-[border-color,box-shadow] duration-200 hover:border-green-accent/40 hover:shadow-lg hover:shadow-green-accent/5 cursor-pointer">
      <div className="mb-4 overflow-hidden rounded-lg bg-bg-alt p-3">
        <MiniViz type={feature.vizType} />
      </div>
      <h3 className="font-display text-xl font-semibold text-text-primary">
        {feature.title}
      </h3>
      <p className="mt-2 flex-1 font-body text-[15px] leading-relaxed text-text-secondary">
        {feature.description}
      </p>
    </div>
  );
